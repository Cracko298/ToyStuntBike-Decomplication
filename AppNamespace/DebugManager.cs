...
public class DebugManager
{
	...
	public void DEBUG_DrawLine(Vector2 start, Vector2 end, Vector3 col, bool bDraw)
	{
		...
		{
			Program.m_App.DrawLine(start, end, new Color(byte.MaxValue, byte.MaxValue, byte.MaxValue, byte.MaxValue), 3f);
		}
	}
	...
	public void DEBUG_DrawText(string text, Vector2 pos, bool bDraw)
	{
		...
		if (Program.m_App.m_SpeechFont != null)
		{
			...
			((Color)(ref val2))._002Ector(1f, 1f, 1f, 0.5f);
			Program.m_App.m_SpriteBatch.Begin((SpriteBlendMode)1, (SpriteSortMode)0, (SaveStateMode)1);
