...
public class Help
{
	...
	public static Vector2 HELP_TOP_OFFSET = new Vector2(-250f, HELP_TOP.Y - 30f);
	...
	public void Start()
	{
		...
		m_SubMenuPosition = HELP_TOP + (float)(m_SubMenuState - 20) * HELP_OFFSET;
	...
	public void Draw()
	{
		...
		for (int i = 0; i < 15; i++)
		{
			m_App.m_SpriteBatch.DrawString(m_App.m_SmallFont, m_App.GetText((App.TEXTID)(127 + i)), hELP_TOP, Color.White);
			hELP_TOP.Y += 35f;
		}
		hELP_TOP.X = 120f;
		hELP_TOP.Y = 545f;
