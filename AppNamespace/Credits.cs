...
public class Credits
{
	...
	public void Start()
	{
		...
		m_SubMenuPosition = CREDITS_TOP + (float)(m_SubMenuState - 20) * CREDITS_OFFSET;
	...
	public void Draw()
	{
		...
		for (int i = 0; i < 15; i++)
		{
			...
			m_App.m_SpriteBatch.DrawString(m_App.m_SmallFont, m_App.GetText((App.TEXTID)(111 + i)), cREDITS_TOP, val);
			cREDITS_TOP.Y += 35f;
		}
		cREDITS_TOP.X = 120f;
		cREDITS_TOP.Y = 545f;
