...
public class FrontEnd
{
	...
	private const float FRENCH_OFFSET = -40f;
	...
	public static Vector2 TEXT_TOP = new Vector2(400f, 200f);

	public static Vector2 TEXT_OFFSET = new Vector2(0f, 60f);

	public static Vector2 TEXT_ARE_YOU_SURE = new Vector2(500f, 250f);

	public static Vector2 TITLE_TOP_OFFSET = new Vector2(-50f, TEXT_TOP.Y - 110f);
	...
	private void NewGame()
	{
		...
		m_App.m_Medals = 0;
		if (m_App.m_Options.m_Difficulty == 1)
		{
			m_App.m_Lives = 10;
		}
		else
	...
	private void GetMenuColour(out Color c, App.TEXTID highlightedId)
	{
		...
		if (highlightedId == App.TEXTID.CONTINUE && !m_bGameStarted && !SaveExists())
		{
			c = new Color(0.8f, 0.7f, 0.6f, 0.25f);
		}
	}
	...
	public void Draw()
	{
		...
		{
			((Vector2)(ref val))._002Ector(150f, 155f);
			m_App.m_SpriteBatch.DrawString(m_App.m_SmallFont, "Global Track Times not available in Trial Mode.", val, Color.Yellow);
		}
		if (m_App.m_PermissionTime > (float)m_App.m_GameTime.TotalGameTime.TotalMilliseconds)
		{
			((Vector2)(ref val))._002Ector(220f, 180f);
